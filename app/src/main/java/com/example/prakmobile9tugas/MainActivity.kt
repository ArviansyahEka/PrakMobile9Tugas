...
import com.example.prakmobile9tugas.network.ApiClient
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        response.enqueue(object : Callback<Hero> {
            override fun onResponse(call: Call<Hero>, response: Response<Hero>) {
                ...
                // Set the ArrayAdapter to your ListView or other UI component if needed

                with(binding) {
                    rvHero.apply {
                        adapter = ItemAdapter(response.body()!!.data)
